...
if __name__ == "__main__":
    ...
    dir = 'example_data/Thermus thermophilus/Thermus thermophilus HB27/'

    genome = Genome()
    genome.load_all_genbanks_in_folder(dir)
    genome.analyse_codon_usage()
    genome.save_relative_codon_table_as_json('Thermus thermophilus HB27', dir=dir)
    ...
    genome.save_relative_codon_table_as_json(id, dir=genome_dir)
    """