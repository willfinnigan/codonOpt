...
# ------------------------------------
def import_protein_seqs_for_optimisation(location, file, file_type):
...
def output_dna_sequence_dict_as_fasta(location_output, file_name_output, dict_of_sequences):
